...
-- ====== OPTIMIZED SCRIPT - FIX OUT OF LOCAL REGISTERS ======
...
Button.Image = "rbxassetid://4781549789"
...
Shadow.Image = "rbxassetid://4781549789"
...
Glow.Image = "rbxassetid://4781549789"
...
local Window = Fluent:CreateWindow({
    Title = "Rabbit HUB | " .. Fluent.Version,
    SubTitle = "One Piece Final 6.0 Update",
    TabWidth = 160,
    Size = UDim2.fromOffset(525, 450),
    Acrylic = true,
    Theme = "Darker",
    MinimizeKey = Enum.KeyCode.P,
    -- THÊM DÒNG NÀY CHO MOBILE
    IgnoreGuiInset = true,  -- Cho phép touch xuyên qua menu
})

local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "layout-dashboard" }),
    Farm = Window:AddTab({ Title = "Farm Setting", Icon = "shovel" }),
    Hakis = Window:AddTab({ Title = "Haki Farm", Icon = "book" }),
    Samauto = Window:AddTab({ Title = "Compass", Icon = "compass" }),
    ...
    Fruits = Window:AddTab({ Title = "Bring Other", Icon = "box" }),
...
-- ====== FARM VARIABLES ======
_G.SelectedMobs = {}
_G.IsAutoFarmEnabled = false
_G.FarmMode = "Đứng kế bên"
_G.OffsetDistance = 3
_G.IsBringMobsEnabled = false
_G.SelectedWeapon = nil
_G.AutoEquipWeapon = false
_G.SelectedKeys = {}
_G.AutoSkillSpam = false
_G.HoldKeys = {}
_G.HoldEnabled = false
_G.HoldTime = 1
_G.AutoFarmChests = false
_G.Running = false
_G.DrinkEnabled = false
_G.AutoDrink = false
_G.AutoMixerFruit = false
...
_G.autoPullEnabled = false
_G.AutoOpenFish = false

-- ====== TELEPORT ======
_G.AutoTeleport = false
_G.teleportLoopRunning = false
_G.teleportCooldown = 0.01
_G.teleportDistance = 2.5
